...
class ClientServerInterface:
    def __init__(self, master: ctk.CTk | ctk.CTkToplevel, player: Player):
        ...
        self.master = master
        self.master.title("Client Setup")
    ...
    def fill_config_interface(self):
        self.title_label = ctk.CTkLabel(self.main_frame, text="Client Setup", font=("Arial", 20, "bold"), corner_radius=10, text_color="white")
        self.host_entry = ctk.CTkEntry(self.main_frame, 50, placeholder_text="IP Address")
        self.port_entry = ctk.CTkEntry(self.main_frame, 50, placeholder_text="Port")
        self.start_button = ctk.CTkButton(self.main_frame, text="Check config", font=("Arial", 15, "bold"), corner_radius=10,
                                                    command=self.start_client, state=ctk.DISABLED, text_color=("white", "white"))
...
if __name__ == '__main__':
    ...
    app = ctk.CTk()
    server_interface = HostServerInterface(app)
